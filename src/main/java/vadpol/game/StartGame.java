...
import vadpol.util.Localization;
...
//        LOGGER_INFO.info("User enter name");
        System.out.println(Localization.getResourceBundle(arg).getString("name"));
        Player pl = new Player(Helper.getString());
        String line = "";
//        LOGGER_INFO.info("The player chooses how much he will play");
        System.out.println(Localization.getResourceBundle(arg).getString("numberGame"));
...
//        LOGGER_INFO.info("The player chooses start game or not");
        while (!line.equalsIgnoreCase("S")) {
            System.out.println(Localization.getResourceBundle(arg).getString("forStart"));
...
//                LOGGER_INFO.info("Player chooses he ill be playing again or not");
                System.out.println(Localization.getResourceBundle(arg).getString("playAgain"));
                line = Helper.getString();
